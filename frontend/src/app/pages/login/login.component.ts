        ...
        <div class="showcase-content">
          ...
          <div class="showcase-footer">
            <div class="security-pill">
              ...
              <span>Ambiente Protegido AWS Cloud &bull; Criptografia TLS 1.3 &bull; LGPD</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="auth-panel">
        <div class="auth-container">
          ...
          @if (pendingUser()) {
            <div class="pending-box">
              ...
              <p class="pending-message">
                Seu acesso foi registrado no sistema. Por razões de confidencialidade e governança dos dados financeiros da comunidade, 
                um <strong>Administrador do grupo</strong> precisa autorizar o seu perfil.
              </p>

              <div class="pending-action">
                <p class="pending-hint">Após a aprovação pela liderança, basta clicar novamente em <em>Entrar com o Google</em>.</p>
                <button class="btn btn-outline full-width" (click)="resetPending()">
                  &larr; Tentar com outra conta
                </button>
              </div>
            </div>
          } 
          ...
          @else {
            <div class="login-box">
              <div class="google-button-wrapper">
                <!-- Botão Oficial Renderizado pelo Google Identity Services -->
                <div id="google-btn-container" class="google-btn-slot"></div>

                <!-- Botão Customizado Fallback caso a renderização oficial atrase -->
                @if (!googleButtonRendered()) {
                  <button type="button" class="btn-google-custom" (click)="triggerGoogleLogin()">
              ...
              <div class="access-notice">
                ...
                <div class="notice-text">
                  <strong>Acesso Controlado & Seguro</strong>
                  <p>Novos usuários passam por aprovação prévia de um administrador antes de terem acesso liberado aos dados do grupo.</p>
                </div>
              </div>
            </div>
          }
          ...
          <div class="auth-footer">
            ...
            <span class="copyright">AWS Student Builder Group &copy; 2026</span>
          </div>
        </div>
      </div>
    </div>
...
export class LoginComponent implements OnInit, AfterViewInit {
  ...
  initGoogleAuth(attempt = 1) {
    if (typeof google !== 'undefined' && google.accounts?.id) {
      ...
      if (btnContainer) {
        ...
        setTimeout(() => this.initGoogleAuth(attempt + 1), 300);
      }
    } else if (attempt < 15) {
      setTimeout(() => this.initGoogleAuth(attempt + 1), 300);
    }
  ...
  triggerGoogleLogin() {
    if (typeof google !== 'undefined' && google.accounts?.id) {
      ...
      this.toast.info('Carregando serviço de autenticação do Google...');
      this.initGoogleAuth();
    }
  }
